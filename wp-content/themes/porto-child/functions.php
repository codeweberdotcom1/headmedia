							...
							<div class="wpb_wrapper">
								<div class="container">
									...
									<div class="col-12 col-md-12 col-lg-10">
										...
										<div class="col-8 col-md-8 col-lg-12 d-block title-block"><a href='<?php the_permalink(); ?>'><h3 style="font-size: 18px" class="mb-0 mb-lg-3 text-uppercase"><?php the_title(); ?></h3><i title="Подробнее" class="red-tooltip view-more Simple-Line-Icons-arrow-right-circle font-weight-semibold"></i></a>
										</div>
										<div class="porto-separator col-12 mt-3 mt-lg-0">
											<hr class=" separator-line align_center solid" style="background-color: rgba(0,0,0,0.06);">
										</div>
